...
inline constexpr uint16_t kButtonPort = 12347;
inline constexpr uint8_t kStep16Address = 0x48;
...
inline constexpr int kI2CSdaPin = 5;
inline constexpr int kI2CSclPin = 6;
#if defined(D3)
inline constexpr int kButtonPin = D3;
#else
inline constexpr int kButtonPin = 3;
#endif
...
inline constexpr unsigned long kButtonDebounceMs = 30;
inline constexpr unsigned long kDialPollMs = 50;
